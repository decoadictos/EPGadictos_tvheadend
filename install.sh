...
#Downloading DecoAdictos epg
echo "Downloading epg DecoAdictos"
wget https://github.com/decoadictos/EPGadictos_tvheadend/raw/master/epgdecoadictos.tar.gz

#Uncompessing epg DecoAdictos
echo "Uncompressing epg DecoAdictos"
mkdir -p /home/hts/.hts/tvheadend/.instalacion_tmp
tar -xzvf epgdecoadictos.tar.gz -C .instalacion_tmp
rm -fr epgdecoadictos.tar.gz
